...
// AES key for kirk1
u8 kirk1_key_enc[16] =  {0x98, 0xC9, 0x40, 0x97, 0x5C, 0x1D, 0x10, 0xE8, 0x7F, 0xE6, 0x0E, 0xA3, 0xFD, 0x03, 0xA8, 0xBA};
...
int kirk_init()
{
    AES_set_key(&aes_kirk1, kirk1_key_enc, 128);
...
int kirk_CMD0(void* outbuff, void* inbuff, int size)
{
	...
	header = (KIRK_CMD1_HEADER_ENC*)outbuff;
...
int kirk_CMD1(void* outbuff, void* inbuff, int size)
{
	...
	header = (KIRK_CMD1_HEADER_ENC*)inbuff;
	if(header->mode != KIRK_MODE_CMD1)
		return KIRK_INVALID_MODE;
